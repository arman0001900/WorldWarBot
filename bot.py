...
def create_shop_menu():
    keyboard = [
        ...
        [{"text": "🛡️ پدافند", "callback_data": "shop_air_defense"}],
        [{"text": "🚁 بالگرد", "callback_data": "shop_helicopters"}],
        [{"text": "🏭 کارخانه", "callback_data": "shop_factories"}],
        [{"text": "🚙 خودرو نظامی", "callback_data": "shop_military_vehicles"}],
        [{"text": "🔫 توپ خانه", "callback_data": "shop_artillery"}],
        [{"text": "⛵ ناو", "callback_data": "shop_navy"}],
        [{"text": "🚀 موشک", "callback_data": "shop_missiles"}],
        [{"text": "🔧 کارخانه تجهیزات", "callback_data": "shop_equipment_factory"}],
...
💰 قیمت: 750K
        ...
        keyboard = {
            "inline_keyboard": [
                ...
                [{"text": "🛒 خرید Su-34", "callback_data": "buy_su34"}],
                [{"text": "🔙 بازگشت به فروشگاه", "callback_data": "normal_shop"}]
            ]
        }
        edit_message(chat_id, message_id, text, keyboard)
